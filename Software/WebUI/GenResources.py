...
# Title of program
GEN_RESOURCES_TITLE = "Ringgit"

# UI Variants
DEFAULT_UI = "Ringgit"
GEN_HELP_TEXT = '--UI Ringgit'

# Path to the src folder which is to contain the GenResources.h file
GEN_RESOURCES_H_FOLDER = "../Particle/src"
...
outFilePath = os.path.abspath(os.path.join(GEN_RESOURCES_H_FOLDER, "GenResourcesOv.h"))
with open(outFilePath, "w") as outFile:
    ...
    outFile.write("static RdWebServerResourceDescr genResourcesOv[] = {\n")
